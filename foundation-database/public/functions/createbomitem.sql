...
DROP FUNCTION IF EXISTS createBOMItem(INTEGER, INTEGER, INTEGER, INTEGER, CHAR, INTEGER, NUMERIC, NUMERIC, DATE, DATE, BOOL, INTEGER, BOOL, TEXT, CHAR, INTEGER, INTEGER, TEXT, TEXT, TEXT);
